...
public class SchoolController {
    ...
    public String getSchool(Model model,
        ...
        model.addAttribute("schools",repository.findById(id)); // TODO : find one school by id
    ...
    public String postSchool(@ModelAttribute School school) {
        ...
        repository.save(school); // TODO : create or update a school
    ...
    public String deleteSchool(@RequestParam Long id) {
        ...
        repository.deleteById(id);  // TODO : delete a school
